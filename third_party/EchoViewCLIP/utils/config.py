...
_C.DATA.TRAIN_FILE = ''
_C.DATA.VAL_FILE = ''
_C.DATA.DATASET = 'ultracls'
_C.DATA.INPUT_SIZE = 224
_C.DATA.NUM_FRAMES = 16
_C.DATA.NUM_CLASSES = 38
_C.DATA.NUM_QUALITIES = 3
_C.DATA.LABEL_LIST = 'labels/ultracls.csv'
...
_C.TRAINER.ViFi_CLIP.CTX_INIT_NO = "a photo without a"  # initialization words (only for language prompts)
