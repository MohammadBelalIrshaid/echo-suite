...
def parse_option():
    ...
    parser.add_argument('--config', '-cfg', required=True, type=str, default='configs/fully_supervised/ultracls/16_16_vifi_clip.yaml')
    parser.add_argument(
        "--opts",
...
def plot_roc_curve(y_true, y_score, num_classes, outdir):
    ...
    outpath = os.path.join(outdir, 'roc_curve_all.png')
